    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-2">
                Rs. {totalPurchases.toLocaleString('en-PK', { minimumFractionDigits: 2 })}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600 dark:text-green-400 mt-2">
                Rs. {totalPaid.toLocaleString('en-PK', { minimumFractionDigits: 2 })}
              </p>
            </div>
        ...
        <Card hover gradient>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Payable</p>
      ...
      <Card padding="none">
        {loading ? (
          ...
          <EmptyState
            ...
            description={searchQuery ? 'Try adjusting your search terms' : 'Create your first purchase order to get started'}
            action={
              !searchQuery ? (
                <Button onClick={() => window.location.href = '/purchases/new'}>
                  <Plus className="w-4 h-4" />
                ...
                <TableRow key={purchase.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-gradient-to-br from-green-400 to-green-600 dark:from-green-500 dark:to-green-700 rounded-full flex items-center justify-center text-white font-semibold text-xs">
                        {purchase.vendor.name.charAt(0).toUpperCase()}
                      </div>
                      <span className="font-medium text-gray-900 dark:text-white">{purchase.vendor.name}</span>
                    </div>
                  </TableCell>
                  ...
                  <TableCell className="text-right font-semibold">
                    Rs. {purchase.totalAmount.toLocaleString('en-PK', { minimumFractionDigits: 2 })}
                  </TableCell>
                  <TableCell className="text-right text-green-600 dark:text-green-400">
                    Rs. {purchase.paidAmount.toLocaleString('en-PK', { minimumFractionDigits: 2 })}
                  </TableCell>
                  <TableCell className="text-right">
                    <span className={purchase.dueAmount > 0 ? 'text-red-600 dark:text-red-400 font-semibold' : 'text-gray-600 dark:text-gray-400'}>
